...
- [x] T027 [P] [US1] Create upload benchmarks in `raps-oss/benches/` ✅
...
- [x] T084 [P] Update `raps/README.md` with architecture overview ✅
- [x] T085 [P] Update `raps/CHANGELOG.md` with v3.2.0 changes ✅
- [x] T086 [P] Create architecture diagram in `raps-website/` ✅
- [x] T087 [P] Document tier feature matrix ✅
