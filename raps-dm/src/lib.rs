...
#[derive(Debug, Deserialize)]
struct GqlHubsData {
    hubs: GqlPaginated<GqlHub>,
}

#[derive(Debug, Deserialize)]
struct GqlProjectsData {
    projects: GqlPaginated<GqlProject>,
}

#[derive(Debug, Deserialize)]
struct GqlPaginated<T> {
    results: Vec<T>,
    pagination: Option<GqlPagination>,
}

#[derive(Debug, Deserialize)]
struct GqlPagination {
...
struct GqlProject {
    id: String,
    name: String,
    alternative_identifiers: Option<GqlAltIds>,
}

#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
struct GqlAltIds {
    data_management_api_project_id: Option<String>,
}
