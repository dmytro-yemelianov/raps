...
- **Policy**: Rule set defining allowed/denied operations per role
- **Tenant**: Isolated configuration context for multi-customer management
- **SsoSession**: SSO authentication state with identity token and APS token mapping
